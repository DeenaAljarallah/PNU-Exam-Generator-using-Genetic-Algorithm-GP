<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamPaperPrint.aspx.cs" Inherits="PNUExamGenerator.ExamPaperPrint" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="ExamPaperReport.rpt">
            </Report>
